...
export async function POST(request: Request) {
  try {
    ...
    try {
      ...
      // `result.registration_error`, when present, means the save
      // succeeded but the number isn't actually live — the UI reads
      // that field to show the specific remediation step instead of a
      // generic toast.
