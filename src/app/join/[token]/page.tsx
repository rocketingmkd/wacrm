...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça pra quem te convidou enviar um novo link.',
  },
  used: {
    title: 'Convite já utilizado',
    body: 'Este convite já foi aceito. Se não foi você, peça ao administrador da conta pra enviar um novo link.',
  },
  expired: {
    title: 'Convite expirado',
    body: 'Este convite expirou. Peça ao administrador da conta pra enviar um novo, leva só alguns segundos pra gerar.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não conseguimos verificar esse convite agora. Tente atualizar a página em instantes.',
  },
};
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 409) {
          setConflictMessage(
            payload.error ||
              'Você já está em outra conta. Entre com um e-mail diferente para acessar esta.',
          );
        } else {
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                saia e cadastre-se novamente com um e-mail diferente.
                O link do convite continua válido enquanto não expirar.
              </p>
            </div>
