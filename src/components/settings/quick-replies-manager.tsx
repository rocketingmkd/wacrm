  ...
  return (
    <div>
      <SettingsPanelHead
        ...
        description="Trechos reutilizáveis (texto simples ou uma mensagem interativa salva) que os atendentes podem inserir direto do compositor da caixa de entrada."
        action={
